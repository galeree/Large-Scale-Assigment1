...
public class KMeans extends Configured implements Tool{
	...
	public static String input_path = "/user/hadoop/project_dekd/result/part-00000";
	public static String output_path = "";
	public static String center_path = "";
	public static String old_center_path = "";
	public static String dir_path = "/user/hadoop/project_dekd/centroid";
	...
	public static void main(String[] args) throws Exception {
		...
		int iteration = 0;
		center_path = dir_path+"/center-" + iteration + "/part-00000";
		output_path = dir_path+"/center-"+ (iteration+1);
		while(iteration < MAX_ITERATION && !isdone) {
			...
			old_center_path = dir_path+"/center-" + iteration + "/part-00000";
		...
		String[] job = new String[]
				{
						...
						"-cacheFile" , center_path+"#part-00000" ,
						"-file"     , code_path+"mapreduce7.py",
						"-mapper"   , code_path+"mapreduce7.py mapper" ,
					    "-reducer"  , code_path+"mapreduce7.py reducer",
					    "-input"    , input_path ,
					    "-output"   , output_path
				};    
