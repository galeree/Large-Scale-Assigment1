...
public class KMeans extends Configured implements Tool{
	...
	public static String dir_path = "hdfs://172.16.2.1:9000/user/hadoop/project_dekd/centroid";
		...
		String[] job = new String[]
				{
					    ...
					    "-file"     , path+"mapreduce6.py",
					    "-file"     , center_path ,
						"-mapper"   , path+"mapreduce6.py mapper" ,
					    "-reducer"  , path+"mapreduce6.py reducer",
					    "-input"    , input_path ,
					    "-output"   , output_path
				};
